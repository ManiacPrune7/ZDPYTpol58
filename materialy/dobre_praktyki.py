class Calculator:
    ...
    def DivideTwoNumbers(self, NUMBER, NUMBER1):
        print(
            "In a moment the method called DivideTwoNumbers"
            "will divide two numbers: number/number1, the result will"
            "be printed on a terminal, so you will have a chance to see"
            "it live"
        )
        a = NUMBER / NUMBER1
        print(f"a")
